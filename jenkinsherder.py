...
dummy_config = {
    ...
    'jenkins_build_tag': 'jenkins-xxxx-xxxxxxxxxxxxxx',
    'jenkins_build_url': 'http://pf-jenkins.qa.mtv2.mozilla.com:8080/view/webrtc-aurora/job/webrtc-nightly-win64-aurora-linux64',
    'job_name': 'WebRTC Steeplechase Pair',
    'job_symbol': 'p',
    'os1': 'mac-10.10',
    'os2': 'win7-64',
    'files': {},
    'prefs_file': 'prefs_general.js',
    'steeplechase': 'runsteeplechase.py',
    'specialpowers_path': './specialpowers',
    'platform_info2':  { 'build':
                            {
                            'product': 'Firefox',
                            'release': 'aurora',
                            'repo': 'mozilla-aurora',
    ...
    'system': {'firefoxes': '/home/mozilla/firefoxes'},
    'times': {
        'submit_timestamp': '1432220927',
        'start_timestamp': '1432220800',
        'end_timestamp': '1432220858',
        'push_timestamp': '1432220749'
    },
    'html_manifest': 'steeplechase.ini',
    'log_dest': './logs',
    'platform_info': { 'build':
                        {
                        'product': 'Firefox',
    ...
    'signalling_server': 'signal.blah.com',
}
dummy_results = {
        'clients': [],
        'total passed': 0,
...
def get_config(argv):
    dummy_config.update(treeherder_config.config)
    return dummy_config
    """
...
def main(argv):
    ...
    # Each job represents one Firefox instance in the WebRTC pair
    # TODO distinguish between client1 and client2 logs
    ...
    # TODO fake a TestResult instance?
